...
using Commands.Pickup.DelieveryRequest;
...
public class PickupTests
{
    ...
    public async Task BobSendsBasicMessageToAliceAndAliceGetsStatusForAllDids()
    {
        ...
        _statusRequestHandler = new StatusRequestHandler(_mediatorMock.Object, _httpClient, simpleDidDocResolverForAlice, secretResolverInMemoryForAlice);
    ...
    public async Task BobSendsBasicMessageToAliceAndAliceGetsTheMessageFromTheMediator()
    {
        ...
        // Alice asks the Mediator for new Messages 
        _deliveryRequestHandler = new DeliveryRequestHandler(_mediatorMock.Object, _httpClient, simpleDidDocResolverForAlice, secretResolverInMemoryForAlice);
        var limit = 100;
